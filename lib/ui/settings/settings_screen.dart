          ...
          listener: (context, state) {
            if (state is DefaultForecastChangeSuccess) {
              ...
              Scaffold.of(context).showSnackBar(SnackBar(
                  ...
                  content: Text("Ustawiono domyślną pogodę.")));
            }
            if (state is DefaultForecastChangeFailure) {
              bloc.add(SetInitialState());
              Scaffold.of(context).showSnackBar(SnackBar(
                  backgroundColor: Color.fromRGBO(50, 130, 209, 1.0),
                  content: Text("Nie udało się zmienić domyślnej pogody.")));
            }
          },
          bloc: bloc,
                    ...
                    child: Padding(
                      ...
                      child: Column(
                        children: <Widget>[
                          ...
                          GestureDetector(
                            onTap: () =>
                                _openChangeDefaultForecastWidget(appState),
                            child: Container(
                                height: 30,
                                child: Row(
                                  children: <Widget>[
    ...
    showCupertinoModalPopup(
        ...
        builder: (BuildContext builder) {
          return _buildBottomPicker(CupertinoPicker(
            backgroundColor:
                appState.isDarkModeOn ? CustomStyles.appGray : Colors.white,
